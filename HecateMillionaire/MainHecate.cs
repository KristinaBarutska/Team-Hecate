namespace HecateMillionaire
{
    ...
    public class MainHecate
    {
        ...
        public static void Main()
        {
            ...
            GameWithLevels game = GameWithLevels.GetInstance();
            game.StartGame();
            ...
            */
            ...
            IList<IQuestion> quest = level.GetLevelQuestionsFromList();

            foreach (var item in quest)
            {
                System.Console.WriteLine(item.QuestionText);
            }

            System.Console.WriteLine(level.QuestionScore);
            System.Console.WriteLine(level.TimerSeconds);

            System.Console.WriteLine(level.IsSkipped);
             */
